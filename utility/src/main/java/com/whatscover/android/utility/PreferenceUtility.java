...
public class PreferenceUtility {
    ...
    private static PreferenceUtility prefsInstance;

    private static final String preferencesName =  "whats_preferences";
...
protected  Context mContext;
    ...
    protected PreferenceUtility(@NonNull Context context){
     ...
     */
    public static PreferenceUtility with(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new PreferenceUtility(context);
        }
    ...
    public String read(int what) {
        return read(mContext.getString(what));
    }
     ...
     * @param what
     */
    public void write(int where, String what) {
        write(mContext.getString(where),what);
    }
